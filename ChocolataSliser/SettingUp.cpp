...
void ChocolataSlicer::setup() {
    ...
    Instrumentor::Get()._slicerLogger.write(ci::log::Metadata(), "ChocolataApps -> ChocolataSlicer executed version = " __ChocolataSlicer_Version_ );
    ...
    {
        CHOCOLATA_SLIER_PROFILE_SCOPE("InitOpenGL");
    ...
    // ImGui Initializing
    {
        CHOCOLATA_SLIER_PROFILE_SCOPE("InitImGui");
        ImGui::Initialize();
        ...
        Instrumentor::Get()._slicerLogger.write(ci::log::Metadata(), "ImGui is initialized -> Fonts loaded(assets/fonts/fa-solid-900.ttf | assets/fonts/fa-brands-400.ttf)" );
        }


    // Main Ui Initializing
    {
        CHOCOLATA_SLIER_PROFILE_SCOPE("InitMainUI");
        ...
        Instrumentor::Get()._slicerLogger.write(ci::log::Metadata(), "Main UI is initialized -> Windows opened(Editor | Content bar)" );
    ...
    Command _cmd;
    Receiver::getInstance().readCommand(&_cmd);
